Public Class Computer
    ...
    Public Shared Function LoadComputers()
        ...
        If System.IO.File.Exists(My.Application.Info.DirectoryPath & "\computers.csv") = True Then
            computersString = My.Computer.FileSystem.ReadAllText(My.Application.Info.DirectoryPath & "\computers.csv", System.Text.Encoding.UTF32)
        End If
